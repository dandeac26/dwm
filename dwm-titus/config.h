...
// static const char *fonts[]                    = { "MesloLGS Nerd Font Mono:pixelsize=23", "NotoColorEmoji:pixelsize=25:antialias=true:autohint=true" };

static const char *fonts[]          = { "monospace:size=17", "FontAwesome5Brands:size=18:antialias:true", "FontAwesome5Free:size=9:antialias:true", "FontAwesome5Free:style=Solid:size=9:antialias:true"};
